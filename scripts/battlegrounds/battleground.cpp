...
bool GossipHello_npc_battleground_vehicle(Player* pPlayer, Creature* pCreature)
{
    pPlayer->CLOSE_GOSSIP_MENU();
    ((npc_battleground_vehicleAI*)pCreature->AI())->StartEvent(pPlayer, pCreature);
         return true;
}
...
void AddSC_battleground()
{
    ...
    pNewScript = new Script;
    pNewScript->Name = "npc_battleground_vehicle";
    pNewScript->GetAI = &GetAI_npc_battleground_vehicle;
    pNewScript->pGossipHello = &GossipHello_npc_battleground_vehicle;
    pNewScript->RegisterSelf();
}
